        ...
        <footer className="bg-surface border-t border-border mt-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Brand */}
                    <div>
                        <h3 className="text-xl font-bold text-primary mb-4">Pronoia</h3>
                        <p className="text-secondary text-base leading-relaxed">
                            Engineered happiness through attentional responsibility.
                        </p>
                    </div>

                    {/* Links */}
                    <div>
                        <h4 className="font-semibold text-primary mb-4">Navigate</h4>
                ...
                {/* Copyright */}
                <div className="mt-8 pt-8 border-t border-border text-center text-secondary text-sm">
                    <p>© {currentYear} Pronoia. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
